...
public class SmartShoot extends Command {
  ...
  public boolean isArmInTargetPose() {
    Logger.recordOutput("SmartShoot/IsArmInTargetPose", arm.isArmInTargetPose());
    Logger.recordOutput("SmartShoot/ArmAngle", arm.getArmAngleRelative());
    Logger.recordOutput("SmartShoot/TargetArmAngle", arm.getRelativeArmTarget());
    return arm.isArmInTargetPose();
  }
