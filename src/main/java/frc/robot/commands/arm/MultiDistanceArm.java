...
public class MultiDistanceArm extends Command {
  ...
  public MultiDistanceArm(
    ...
    distanceMap.put(3.5, 27.0); // 21.6 match 21.98(V3s)
    distanceMap.put(4.0, 30.75); // 21.6 match 21.98(V3s)
    distanceMap.put(4.25, 31.75); // 21.6 match 21.98(V3s)
    distanceMap.put(4.5, 33.00); // 21.6 match 21.98(V3s)
    distanceMap.put(5.0, 34.75); // 21.6 match 21.98(V3s)
    distanceMap.put(5.5, 35.50); // 21.6 match 21.98(V3s)
    distanceMap.put(6.0, 37.00); // 21.6 match 21.98(V3s)
    distanceMap.put(6.5, 38.25); // 21.6 match 21.98(V3s)
    distanceMap.put(7.0, 40.5); // 21.6 match 21.98(V3s)
    distanceMap.put(8.0, 41.25); // 21.6 match 21.98(V3s)
    distanceMap.put(8.5, 41.75); // 21.6 match 21.98(V3s)
    distanceMap.put(9.0, 42.5); // 21.6 match 21.98(V3s)
    distanceMap.put(9.5, 42.75); // 21.6 match 21.98(V3s)
  }
