...
//   public ShootDistance(Supplier<Pose2d> poseSupplier, Pose2d targetPose, Shooter flywheel) {
//     this.poseSupplier = poseSupplier;
//     this.targetPose = targetPose;
//     this.shooter = shooter;
//     // First value would be distance from target, second value would be speed or angle depending
// on
//     // application
//     // In this case RPM
