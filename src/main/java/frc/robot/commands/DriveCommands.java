...
public class DriveCommands {
    ...
    private static final LoggedTunableNumber autoAimFieldVelocityDeadband = new LoggedTunableNumber(
            "autoaim/fieldvelocitydeadband", 0.5);
    ...
    public static final Command joystickDrive(
        ...
        return Commands.run(
                () -> {
                    ...
                    Translation2d deadbandFieldRelativeVelocity = (drive.getFieldRelativeVelocity()
                            .getNorm() < autoAimFieldVelocityDeadband.get())
                                    ? new Translation2d(0, 0)
                                    : drive.getFieldRelativeVelocity();
                    long currentTime = Logger.getRealTimestamp();
                    Translation2d deadbandFieldRelativeAcceleration = deadbandFieldRelativeVelocity
                    ...
                    if (SmartController.getInstance().isSmartControlEnabled()
                        ...
                        AimingParameters calculatedAim = SmartController.getInstance().getTargetAimingParameters();
