...
public class SwerveModule {
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean closedLoop) {
        ...
        // appropriately
        // compared to the current angle from the CANCoder. We verified that you need
        // constrainState()
    ...
    public void setDesiredStateNoOptimize(SwerveModuleState desiredState, boolean closedLoop) {
        ...
        desiredState = constrainState(desiredState); // constrain one more time after optimization just to be safe,
                                                     // because I'm unsure if optimization can ever pull the angle out
                                                     // of [-180, 180]
