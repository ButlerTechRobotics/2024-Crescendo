...
public class SwerveModuleIOKraken implements SwerveModuleIO {
     ...
     * @param cancoderID         - ID of the absolute CANcoder mounted ontop of the
     *                           swerve
     * @param isDriveMotorOnTop  - Is drive motor mounted on top
     * @param isAngleMotorOnTop  - Is angle motor mounted on top
     */
    public SwerveModuleIOKraken(int driveMotorID, int angleMotorID, double angleOffsetDegrees, int cancoderID,
