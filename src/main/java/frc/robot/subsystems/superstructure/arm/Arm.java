...
//             "Arm Joint",
//             armOrigin2d.getX() + DriveConstants.drivetrainConfig.trackwidthX() / 2.0,
//             armOrigin2d.getY());
//     armMeasured =
//         new MechanismLigament2d(
//             "Arm Measured",
//             armLength,
//             Units.radiansToDegrees(inputs.armAbsolutePositionRad),
//             2.0,
...
//           inputs.armRelativeVelocityRadPerSec, 0.0, Units.degreesToRadians(1.0))) {
//         homingTimer.start();
//       } else {
//         homingTimer.reset();
//       }
...
//     // Logs
//     armMeasured.setAngle(Units.radiansToDegrees(inputs.armAbsolutePositionRad));
...
//     return Rotation2d.fromRadians(inputs.armAbsolutePositionRad);
//   }
...
//     return Math.abs(inputs.armAbsolutePositionRad - setpoint) <= armTolerance.get();
//   }
...
//         .until(() -> Math.abs(inputs.armRelativeVelocityRadPerSec) >= Units.degreesToRadians(10))
