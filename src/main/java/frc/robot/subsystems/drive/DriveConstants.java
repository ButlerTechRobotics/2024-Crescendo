        ...
        case COMPBOT ->
            new ModuleConfig[] {
              ...
              new ModuleConfig(
                  ...
                  4,
                  10,
                  Rotation2d.fromRotations(0.210938).plus(Rotation2d.fromDegrees(0)),
                  true),
              new ModuleConfig(
                  5,
                  6,
                  11,
                  Rotation2d.fromRotations(0.235840).plus(Rotation2d.fromDegrees(180)),
                  true),
              new ModuleConfig(
                  7,
                  8,
                  12,
                  Rotation2d.fromRotations(-0.386719).plus(Rotation2d.fromDegrees(0)),
                  true)
            };
