...
public final class DriveConstants {
  public static DrivetrainConfig drivetrainConfig = switch (Constants.getRobot()) {
    default ->
  ...
  public static ModuleConfig[] moduleConfigs = switch (Constants.getRobot()) {
    case COMPBOT ->
      new ModuleConfig[] {
          new ModuleConfig(
              1,
              2,
              9,
              Rotation2d.fromRotations(0.482178).plus(Rotation2d.fromDegrees(180)),
              false),
          new ModuleConfig(
              3,
              4,
              10,
              Rotation2d.fromRotations(-0.419).plus(Rotation2d.fromDegrees(180)),
              false),
          new ModuleConfig(5, 6, 11, Rotation2d.fromRotations(-0.253), false),
          new ModuleConfig(
              7, 8, 12, Rotation2d.fromRotations(0.268).plus(Rotation2d.fromDegrees(180)), false)
      };
