...
public class AprilTag extends SubsystemBase {
  ...
  private final AtomicReference<EstimatedRobotPose> atomicEstimatedAtomicReference =
            ...
            .ifPresent(
                estimatedRobotPose -> {
                  ...
                  if (estimatedPose.getX() > 0.0
                      && estimatedPose.getX() <= 16.51
                      && estimatedPose.getY() > 0.0
                      && estimatedPose.getY() <= 8.211
                      && Math.abs(estimatedPose.getZ()) <= 0.15) {
