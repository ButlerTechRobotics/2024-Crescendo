...
//           DriverStation.getAlliance(); // Retrieves the alliance information from the
// DriverStation
...
//       timestamp -= (latencyMS / 1e3); // Adjusts the timestamp by subtracting the latency in
// seconds
...
//         poseEstimates; // Assigns the poseEstimates ArrayList to the inputs.poseEstimates
// variable
//   }
// }
