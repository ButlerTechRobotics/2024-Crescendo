...
//                 timestamp, robotPose.toPose2d(), VecBuilder.fill(xyStdDev, xyStdDev,
// thetaStdDev)));
...
//     return xyStdDevCoefficient * Math.pow(poseEstimates.averageTagDistance(), 2.0) /
// tagPosesSize;
//   }
...
//     Logger.recordOutput(VISION_PATH + Integer.toString(instanceIndex) + "/RobotPose3D",
// robotPose);
//     Logger.recordOutput(
