...
public class FieldConstants {
  ...
  public static final class Speaker {
    ...
    public static Pose2d centerSpeakerOpening = new Pose2d(0.0, fieldWidth - Units.inchesToMeters(104.0),
        new Rotation2d());

    /** Center of the speaker opening (blue alliance) */
    public static Pose2d redSpeakerOpening = new Pose2d(fieldLength, fieldWidth - Units.inchesToMeters(104.0),
        new Rotation2d());

    /** Center of the speaker opening (blue alliance) */
    public static Pose2d blueSpeakerOpening = new Pose2d(0.0, fieldWidth - Units.inchesToMeters(104.0),
        new Rotation2d());
  }
