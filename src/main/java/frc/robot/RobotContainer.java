...
public class RobotContainer {
    ...
    private static final Transform3d robotToCameraFL = new Transform3d(
            new Translation3d(
    ...
    private static final Transform3d robotToCameraFR = new Transform3d(
            new Translation3d(
    ...
    public RobotContainer() {
        switch (Constants.getMode()) {
            case REAL:
                ...
                drive = new Drive(
                        new GyroIOPigeon2(),
                        new SwerveModuleIONeo(3, 1, -0.00342, 7),
                        new SwerveModuleIONeo(2, 2, 0.36816, 6),
                        new SwerveModuleIONeo(1, 5, -0.09009, 5),
                        new SwerveModuleIONeo(0, 6, -0.37622, 4),
