...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand(
                ...
                new MultiDistanceArm(
                        ...
                        .andThen(
                                new InstantCommand(
                                        () -> armPID.setPosition(0.0), armPID))); // Reset the arm position
        ...
        NamedCommands.registerCommand(
                "PreShootAndAim",
                Commands.parallel(
                        NamedCommands.getCommand("PreShoot"),
        ...
        NamedCommands.registerCommand(
                ...
                Commands.sequence(
                        // Step 1: Auto aim
                        NamedCommands.getCommand("PreShootAndAim"),
                        // Step 2: Wait until the arm is at the right angle
                        Commands.waitUntil(armPID::isAtTargetPosition),
                        // Step 3: Shoot
                        NamedCommands.getCommand("Shoot"),
                        // Step 4: Reset the arm
                        new InstantCommand(() -> armPID.setPosition(0), armPID)));
    ...
    public Command ejectNote() {
        return Commands.runOnce(
                () -> superstructure.setGoal(Superstructure.SystemState.IDLE), superstructure)
                .alongWith(
    ...
    private void configureButtonBindings() {
        ...
        // RUN INTAKE IN
        // ================================================
        driverController.leftBumper().whileTrue(intakeNote()).onFalse(
                Commands.runOnce(
                        () -> {
                            rollers.setGoal(Rollers.Goal.IDLE);
                            superstructure.setGoal(Superstructure.SystemState.IDLE);
        ...
        // RUN INTAKE OUT
        // ================================================
        driverController.leftTrigger().whileTrue(ejectNote()).onFalse(
                Commands.runOnce(
                        () -> {
                            rollers.setGoal(Rollers.Goal.IDLE);
                            superstructure.setGoal(Superstructure.SystemState.IDLE);
        ...
        // PATHFIND TO SPEAKER
        // ================================================
        // driverController.povDown().whileTrue(new PathFinderAndFollow("Sub Placement
        // Path"));
        ...
        // ================================================
        operatorController.povDown().onTrue(new PositionArmPID(armPID, 3.25)); // 3
    }
