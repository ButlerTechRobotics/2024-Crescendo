...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        Command threeNoteSourceP54 = Commands.sequence(
                new PathPlannerAuto("Source Drop P Collect 5"), // // Drop P, collect 5
                Commands.either(
                        new PathPlannerAuto("Source Score 5 Collect 4"), // Score 5, collect 4
                        new PathPlannerAuto("Source Missed 5 Collect 4"), // Missed 5, collect 4
                        beamBreak::hasNoteForAuto),
                Commands.either(
                        new PathPlannerAuto("Source Score 4 Collect P"), // Score 4, collect P
                        new PathPlannerAuto("Source Missed 4 Collect P"), // Missed 4 , collect P
                        beamBreak::hasNoteForAuto),
                Commands.either(
                        new PathPlannerAuto("Source Score P"), // Score P
                        new PathPlannerAuto("Source Missed P Sprint Source"), // Missed P, sprint source
                        beamBreak::hasNoteForAuto));
        ...
        // 3 Note Source P-4-5
        // ================================================
        Command threeNoteSourceP45 = Commands.sequence(
                new PathPlannerAuto("Source Drop P Collect 4"), // Drop P, collect 4
                Commands.either(
                        new PathPlannerAuto("Source Score 4 Collect 5"), // Score 4, collect 5
                        new PathPlannerAuto("Source Missed 4 Collect 5"), // Missed 4, collect 5
                        beamBreak::hasNoteForAuto),
                Commands.either(
                        new PathPlannerAuto("Source Score 5 Collect P"), // Score 5, collect P
                        new PathPlannerAuto("Source Missed 5 Collect P"), // Missed 5, collect P
                        beamBreak::hasNoteForAuto),
                Commands.either(
                        new PathPlannerAuto("Source Score P"), // Score P
                        new PathPlannerAuto("Source Missed P Sprint Source"), // Missed P, sprint source
                        beamBreak::hasNoteForAuto));
        autoChooser.addOption("3 Note Source P-4-5", threeNoteSourceP45);
